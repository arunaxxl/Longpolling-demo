...
export class ChartjsBarComponent implements OnDestroy {
  ...
  constructor(private longPollingService:LongPollingService,private theme: NbThemeService,private webSocketService:WebSocketService) {
    this.longPollingService.barChart$.subscribe((data:any)=>{
      this.barChartData1=data.LabelA;
      this.barChartData1=data.LabelB;
      this.drawbarchart();
    })
    this.longPollingService.startPollingBarChart();
  }
